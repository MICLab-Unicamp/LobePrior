...
from src.model.unet_diedre import UNet_SeteDecoders
from src.predict_lung import LungModule
from src.utils.general import pos_processamento, post_processing_dist_lung, post_processing_lung
from src.utils.general import register_single, teste_pickle_by_image, process_images
from src.utils.general import unified_img_reading, busca_path, salvaImageRebuilt, convert_to_nifti, remove_directories_if_exist, collect_images_verbose
from src.utils.general import analyze_registration_quality, find_best_registration
from src.utils.to_onehot import mask_to_onehot
...
class LoberModule(pl.LightningModule):
	...
	def predict(self, npz_path, image_original_path, output_path, group=None, post_processed=True) -> np.ndarray:
		...
		pre_trained_model_lung_path = 'src/weights/LightningLung.ckpt'
