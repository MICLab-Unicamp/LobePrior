...
* Segmentations using the LobePrior, nnUnet and LungMask methods on the CT image coronacases_007 (slice 150), from the Coronacases[1] dataset. Here, it is possible to visualize the segmentation errors (rectangular region) generated by each of the networks, in relation to the \textit{gold standard} (Fig. b):
   ...
   <center>
	 <figure>
	    <img src="https://github.com/MICLab-Unicamp/LobePrior/blob/main/images/coronacases_007/coronacases_007_150_lung.png" alt="CT image", height="200" width="200"><br>CT image</td>
		<img src="https://github.com/MICLab-Unicamp/LobePrior/blob/main/images/coronacases_007/coronacases_007_150_gt.png" alt="Golden pattern", height="200" width="200"><br>Golden pattern</td>
	 </figure>
	</center>
	<center>
	 <figure>
		<img src="https://github.com/MICLab-Unicamp/LobePrior/blob/main/images/coronacases_007/coronacases_007_150_LobePrior_5_2.png" alt="LobePrior", height="200" width="200"><br>LobePrior (0,953)</td>
		<img src="https://github.com/MICLab-Unicamp/LobePrior/blob/main/images/coronacases_007/coronacases_007_150_nnunet_2.png" alt="nnUnet", height="200" width="200"><br>nnUnet (0,943)</td>
		<img src="https://github.com/MICLab-Unicamp/LobePrior/blob/main/images/coronacases_007/coronacases_007_150_LTRCLobes_R231_2.png" alt="LungMask", height="200" width="200"><br>Lungmask (0,945)</td>
	 </figure>
   </center>
