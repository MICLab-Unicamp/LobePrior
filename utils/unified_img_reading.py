...
def unified_img_reading(path, mask_path=None, torch_convert=False, isometric=False, convert_to_onehot=None, show_message=True):
	'''
	...
	#for mode in ['val']:
		...
		for image_path in all_images:
			...
			if torch_convert:
				...
				image, label, spacing = unified_img_reading(image_path, mask_path=label_path, isometric=True, torch_convert=True, convert_to_onehot=6)
				...
				image, label, spacing = unified_img_reading(image_path, mask_path=label_path, isometric=True, torch_convert=False, convert_to_onehot=6)
